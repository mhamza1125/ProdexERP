...
<body>
  <div class="page-layout">
    ...
    <div class="auth-wrapper min-vh-100 px-2" style="background-image: url(assets/images/auth/auth.webp); background-size: cover; background-position: center; background-repeat: no-repeat;">
            ...
            <form action="index.html">
              ...
              <div class="mb-4">
                <div class="d-flex justify-content-between">
                  ...
                  <a href="authentication/forgot-password-basic.html">Forgot Password?</a>
                </div>
              </div>
              <div class="mb-3">
                <button type="submit" value="Submit" class="btn btn-primary waves-effect waves-light w-100">Login</button>
              </div>
              <p class="mb-5 text-center">Don’t have an account? <a href="authentication/register-basic.html">Sign Up here</a>
              </p>
